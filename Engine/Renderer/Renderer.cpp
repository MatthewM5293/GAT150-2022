...
namespace neu
{
	...
	void Renderer::DrawLine(const neu::Vector2& v1, const neu::Vector2& v2, const neu::Color& color)
	{
	...
	void Renderer::DrawPoint(const neu::Vector2& v, const neu::Color& color)
	{
		SDL_SetRenderDrawColor(m_renderer, color.r, color.g, color.b, color.a);
